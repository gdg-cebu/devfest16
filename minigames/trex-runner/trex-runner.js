...
/**
 * T-Rex runner.
 * @param {string} documentCtx Selector for the game's containing element.
 * @param {Object} opt_config
 * @constructor
 * @export
 */
function Runner(documentCtx, opt_config) {
  // Singleton
  if (Runner.instance_) {
  ...
  this.outerContainerEl = this.documentCtx.querySelector('#game-screen');
...
Runner.prototype = {
  ...
  loadImages: function() {
    if (IS_HIDPI) {
      Runner.imageSprite = this.documentCtx.querySelector('#offline-resources-2x');
      this.spriteDef = Runner.spriteDefinition.HDPI;
    } else {
      Runner.imageSprite = this.documentCtx.querySelector('#offline-resources-1x');
  ...
  loadSounds: function() {
    if (!IS_IOS) {
      ...
      var resourceTemplate =
          this.documentCtx.querySelector('#' + this.config.RESOURCE_TEMPLATE_ID).content;

      for (var sound in Runner.sounds) {
        var soundSrc = this.documentCtx.querySelector('#' + Runner.sounds[sound]);
  ...
  gameOver: function() {
    ...
    if (this.distanceRan > this.highestScore) {
      ...
      this.emit('highscore', this.highestScore);
    }
